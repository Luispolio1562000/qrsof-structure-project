...
class SkillControllerImpl @Inject()(val controllerComponents: ControllerComponents, skillService: SkillServiceImpl)(implicit ec: ExecutionContext) extends BaseController with SkillController {
